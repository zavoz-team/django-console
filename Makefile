...
run:
	APP_API_TOKEN="123" APP_SIGNING_KEY="123" APP_CORE_API_SERVICE_TOKEN="123" uv run main.py

run-otel:
	APP_API_TOKEN="123" APP_SIGNING_KEY="123" APP_CORE_API_SERVICE_TOKEN="123" APP_LOGGING_LEVEL=WARNING APP_OTEL_LOGS_ENDPOINT="$(APP_OTEL_LOGS_ENDPOINT)" APP_OTEL_METRICS_ENDPOINT="$(APP_OTEL_METRICS_ENDPOINT)" APP_OTEL_TRACES_ENDPOINT="$(APP_OTEL_TRACES_ENDPOINT)" OTEL_METRIC_EXPORT_INTERVAL="$(OTEL_METRIC_EXPORT_INTERVAL)" uv run main.py
